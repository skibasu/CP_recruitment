...
-   Endpoints for application data
-   Enter objects keys you would like to compare (one key for each url)
-   Names for each group - this names will be displayed on the page (in buttons etc)
-   Range of ids for each endpoint. Random number will be selected from that range and added to endpoint i.e (https://swapi.dev/api/people/id)
